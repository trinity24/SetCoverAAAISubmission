...
#### To generate synthetic dataset with varying `f` $f \in \{3,4,\dots,10\}$  values, use the function `generate_dataset()` in  `python ./notebooks/setcover_dataset.py` with parameters as 
